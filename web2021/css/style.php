...
.header{
	height:100vh;
	width:100%;
	background-image:linear-gradient(rgba(0,168,255,0.3),rgba(0,168,255,0.3)), url('images/n51.jpg');
...
.header:before{
	...
	opacity:-3;
	z-index:-1;
	background:linear-gradient(to right,#1e5799 0%, #3ccdbb 0%, #50d1c0 100%);
}
.navbar:before{
content:"";
	position:absolute;
...
box-shadow0 0 20px 0 rgba(0,0,0,0.3);
}
